...
Demo LimeSpark pentru **PMC Detailing Iași** — detailing complet, folieri PPF, colantări, corecție lac-polish și protecții ceramice. Fără logo furnizat: am generat un wordmark SVG roșu (`assets/logo.svg`). Accent roșu.
