# Service Auto La Punct — Iași

Demo LimeSpark pentru **Service Auto La Punct** (Str. Hlincea nr. 7A, Iași) — **service auto** (nu detailing): diagnoză computerizată, revizii, distribuție, ambreiaj, frâne, suspensie, electrică și climatizare. Accent portocaliu-amber preluat din logo.
