# NTA Detailing — Brăila

Demo LimeSpark pentru **NTA Detailing** (Brăila) — detailing interior/exterior, corecție de vopsea și protecție ceramică. „Fiecare automobil este tratat în funcție de standardele pe care le merită." Brand monocrom (logo alb pe negru) → accent argintiu neutru.
